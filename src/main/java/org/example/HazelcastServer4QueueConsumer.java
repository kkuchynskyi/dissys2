    ...
    public static void main(String[] args) {
        ...
        instance.getClientService().addClientListener(new ClientListener() {
            ...
            public void clientConnected(Client client) {
                System.out.println("Client connected, name=" + client.getUuid() + " uuid=" + client.getUuid());
            }

            @Override
            public void clientDisconnected(Client client) {
                System.out.println("Client disconnected, name=" + client.getUuid() + " uuid=" + client.getUuid());
            }
        });
    }
